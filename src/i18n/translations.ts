...
const translations = {
  pt: {
    ...
    mgmt_title: 'Gestão do robô',
    mgmt_intro:
      'Histórico da sua conta, separado por ativo. O filtro de horário do Close Guard usa o relógio da corretora — converta para o seu fuso antes de configurar.',
    mgmt_account: 'Conta',
    mgmt_symbol: 'Ativo',
    mgmt_period: 'Período',
    ...
    mgmt_clock_mine: 'Meu horário',
    mgmt_broker_time: 'Horário da corretora',
    mgmt_my_time: 'Meu horário',
    mgmt_becomes: 'equivale a',
    mgmt_in_my_zone: 'no meu fuso',
    mgmt_in_broker: 'na corretora (use este no robô)',
    mgmt_best_hour: 'Melhor hora',
    mgmt_best_day: 'Melhor dia',
    mgmt_stress_hour: 'Hora com mais flutuante',
    mgmt_calm_hour: 'Hora mais calma',
    mgmt_by_hour: 'Por hora',
    mgmt_by_day: 'Por dia',
    mgmt_col_hour: 'Hora',
    mgmt_col_day: 'Dia',
    mgmt_col_profit: 'Lucro',
    mgmt_col_trades: 'Fechamentos',
    mgmt_col_float: 'Flutuante médio',
    mgmt_col_worst: 'Pior flutuante',
    mgmt_dd: 'DD',
    mgmt_col_goals_gain: 'Metas de ganho',
    mgmt_col_goals_loss: 'Metas de perda',
    mgmt_days: 'Dom|Seg|Ter|Qua|Qui|Sex|Sáb',
  },
  ...
  es: {
    ...
    mgmt_title: 'Gestión del robot',
    mgmt_intro:
      'Historial de tu cuenta, separado por activo. El filtro de horario del Close Guard usa el reloj del bróker — conviértelo a tu zona antes de configurarlo.',
    mgmt_account: 'Cuenta',
    mgmt_symbol: 'Activo',
    mgmt_period: 'Período',
    ...
    mgmt_clock_mine: 'Mi horario',
    mgmt_broker_time: 'Horario del bróker',
    mgmt_my_time: 'Mi horario',
    mgmt_becomes: 'equivale a',
    mgmt_in_my_zone: 'en mi zona',
    mgmt_in_broker: 'en el bróker (usa este en el robot)',
    mgmt_best_hour: 'Mejor hora',
    mgmt_best_day: 'Mejor día',
    mgmt_stress_hour: 'Hora con más flotante',
    mgmt_calm_hour: 'Hora más calma',
    mgmt_by_hour: 'Por hora',
    mgmt_by_day: 'Por día',
    mgmt_col_hour: 'Hora',
    mgmt_col_day: 'Día',
    mgmt_col_profit: 'Beneficio',
    mgmt_col_trades: 'Cierres',
    mgmt_col_float: 'Flotante medio',
    mgmt_col_worst: 'Peor flotante',
    mgmt_dd: 'DD',
    mgmt_col_goals_gain: 'Metas de ganancia',
    mgmt_col_goals_loss: 'Metas de pérdida',
    mgmt_days: 'Dom|Lun|Mar|Mié|Jue|Vie|Sáb',
  },
} as const;
